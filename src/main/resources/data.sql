INSERT INTO BOOKS (product_type, product_name, author, price, img, about)
VALUES ('Книга', 'Новый год в домике Мышонка', 'Зенькова А.', 2251, 'img/1.jpg', 'Потри пальчиком изображение и понюхай страницу.
       ...
       ('Книга', 'Маленький Единорог', 'Сукгоева А.', 2251, 'img/2.jpg', 'Маленький единорог Лучик вместе со своими друзьями отправился на поиски волшебника фламинго, чтобы попросить его вызвать долгожданный дождь. А тот, читая заклинание, случайно стёр радугу. Без неё не будет больше ни дождя, ни солнца!
       ...
       ('Книга', 'Лисенок Лютер и летнее представление', 'Роулинсон Д.', 684, 'img/3.jpg', 'Сказка «Лисёнок Лютер и летнее представление» Джулии Роулинсон с иллюстрациями Тифани Бик — третья книга о милом лисёнке и его лесных друзьях.
       ...
       ('Книга', 'Маленький принц', 'де Сент-Экзюпери А.', 2534, 'img/4.jpg', 'Самое известное произведение Антуана де Сент-Экзюпери — и самая необычная книга, которая оживает благодаря 3D-объёмным панорамам на каждом развороте.
       ...
       ('Книга', 'Высокий - низкий', 'МОЗАИКА kids издательств', 96, 'img/5.jpg', 'Книжка с наклейками для детей от 3-х лет.
       ...
       ('Книга', 'Котенок Шмяк и лунный кот', 'Скоттон Р.', 344, 'img/6.jpg', 'Однажды Шмяк и Пряник поспорили один был уверен, что с Луны на них смотрит лунный кот, а второй доказывал, что это кратеры от метеоритов.
                                Кто прав? И что сделает мышонок Сырник в этой непростой ситуации?');

INSERT INTO WAREHOUSE (id_products, count)
VALUES (1, 0),
       (2, 2),
       (3, 3),
       (4, 0),
