INSERT INTO BOOKS (product_type, product_name, author, price, img, about) VALUES
    ('Книга', 'Новый год в домике Мышонка', 'Зенькова А.', 2251, 'img/1.jpg', 'Потри пальчиком изображение и понюхай страницу.
